...
// Your function here
//this was a small victory for me. i understand fucntions but for some reason this was giving me trouble. but this is a small victory
//becasue i figured it out without googling it or anything. longgg over due but definitely boosted my confidence.
...
func frequencyDictionary(of string: String) -> Dictionary<Character,Int> {
    
    var dictionary:[Character:Int] = [:]
    
    for char in string {
        
        if let dict = dictionary[char] {
            dictionary[char] = dict + 1
        } else {
            dictionary[char] = 1
        }
...
// Your function here
func fizzBuzz(upto input:Int) -> Array<String> {
